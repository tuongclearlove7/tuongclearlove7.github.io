...
background = pygame.image.load("10.jpg")
...
class my_plane():
    def __init__(self): #biến face được truyền vào self
        ...
        self.Surface = pygame.image.load('14.gif')
    ...
    # Hàm dùng để thay đổi vị trí máy bay
        if Fly_left == True:
            self.Fly -= 2 # tốc độ bắt đầu của máy nay
...
while True: #vòng lặp
    ...
    screen.blit(text,(400,-15))# in ra chữ trên chương trình game
